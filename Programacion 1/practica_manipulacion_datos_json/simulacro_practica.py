...
def reescribir_datos(nombre_archivo:str):
    with open(nombre_archivo, 'w') as archivo:
        json.dump(nombre_archivo, archivo)

archivo = 'C:/Users/marce/Desktop/UTNFRA/Programacion 1/practica_manipulacion_datos_json/data.json'
...
F - Usar ordenamiento burbuja para ordenar los juegos ASC o DESC depende como lo quiera el usuario, hacer un submenu que pregunte que desea ordenar
    1. Nombre.
    2. Empresa.
